...
This is a fork of Vectra (https://github.com/Stevenic/vectra) but it uses pure js instead of using python-gyp to compile the native module. This makes it easier to use in a browser or electron.
